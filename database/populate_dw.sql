...
SELECT * FROM dw.dim_energy_source LIMIT 10;
SELECT * FROM staging.demand LIMIT 10;
SELECT * FROM staging.generation LIMIT 10;
SELECT * FROM dw.fact_generation WHERE indicator_id = 548 LIMIT 10;